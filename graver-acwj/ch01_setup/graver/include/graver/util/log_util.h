...
namespace graver::util {

class LogUtil {
public:
    static void                      init(spdlog::level::level_enum level = config::AppConfig::GetInstance().logLevel(),
    ...
    static void                            createLogger(const std::string        &logger_name,
                                                        spdlog::level::level_enum level = config::AppConfig::GetInstance().logLevel());
    static std::shared_ptr<spdlog::logger> getLogger(
        const std::string &logger_name, spdlog::level::level_enum level = config::AppConfig::GetInstance().logLevel());
